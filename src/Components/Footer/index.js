...
function Footer() {
    return(
        <footer className='container-footer'>
            ...
            <div>
                <p>Copy right @2022 MLP Software House</p>
                <p>Design by Mateus Leite Pedrosa</p>                
            </div>
            <nav>
                <img src={ICON_GMAIL} alt="icone gmail"></img>
                <img src={ICON_LINKEDIN} alt="icone linkedin"></img>
                <img src={ICON_GITHUB} alt="icone github"></img>
            </nav>
        </footer>
    )
}
